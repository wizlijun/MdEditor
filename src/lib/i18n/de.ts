...
export const de: Record<keyof Messages, string> = {
  ...
  'search.index.tiersHint': 'Die Ebenen entstehen beim Indexieren — aus dem Frontmatter jeder Datei und aus den Mustern für rohes Quellmaterial oben; nichts davon wird in deine Notizen zurückgeschrieben. Als „Rohes Quellmaterial“ zählen nur Dateien, die auf eines deiner Muster passen — wirkt diese Zahl ungewöhnlich hoch, ist meist ein Muster weiter gefasst als beabsichtigt. Eine Datei ohne Frontmatter und ohne passendes Muster ist „Nicht gekennzeichnet“: Niemand hat bisher gesagt, wer sie geschrieben hat. Die geänderte Datei wird von selbst neu eingeordnet — der gesamte Index muss dafür nicht angefasst werden.',
