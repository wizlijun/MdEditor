...
export const de: Record<keyof Messages, string> = {
  ...
  'search.index.tiersHint': 'Die Ebenen werden beim Indexieren aus dem Frontmatter jeder Datei abgeleitet — nichts davon wird in deine Notizen zurückgeschrieben. Wirkt „Rohes Quellmaterial“ ungewöhnlich hoch, fehlt den Notizen meist nur Frontmatter; füge ein `type:`-Feld (oder beliebiges Frontmatter) hinzu und speichere. Die geänderte Datei wird von selbst neu eingeordnet — der gesamte Index muss dafür nicht angefasst werden.',
  'search.index.tiersUnlabeledHint': 'Klicke oben auf „{label}“, um im Suchpanel alle Dateien zu öffnen, die durch das Gewicht dieser Ebene gerade herabgestuft werden.',
