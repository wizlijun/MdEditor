...
export const de: Record<keyof Messages, string> = {
  ...
  // Globale intelligente Suche & Antworten
  'smartSearch.windowTitle': 'Intelligente Suche & Antworten',
  'smartSearch.placeholder': 'Vault durchsuchen oder direkt fragen…',
  'smartSearch.inputHint': 'Suche beim Tippen · Eingabe fragt den Agent · ⇧Eingabe fügt eine Zeile ein',
  'smartSearch.modelStrategy': 'Modellstrategie',
  'smartSearch.modelFast': 'Automatisch (schnell)',
  'smartSearch.modelDefault': 'Harness-Standard',
  'smartSearch.planTuneModel': 'Verstehen und optimieren',
  'smartSearch.planTuneModelHint': 'Verwendet standardmäßig das schnelle Modell dieses Agents',
  'smartSearch.answerModel': 'Endgültige Antwort',
  'smartSearch.answerModelHint': 'Verwendet standardmäßig das Qualitätsmodell dieses Agents',
  'smartSearch.planning': 'Frage wird verstanden…',
  'smartSearch.plannedSearching': 'Intelligente Suche läuft…',
  'smartSearch.tuning': 'Suche wird optimiert…',
  'smartSearch.quickPreview': 'Schnellvorschau',
  'smartSearch.intelligentResults': 'Intelligente Suchergebnisse',
  'smartSearch.ask': 'Agent fragen',
  'smartSearch.results': 'Ergebnisse',
  'smartSearch.answer': 'Antwort',
  ...
  'smartSearch.removedCount': '{n} aus dieser Antwort entfernt',
  'smartSearch.undo': 'Rückgängig',
  'smartSearch.notDeleted': 'Originaldateien wurden nicht gelöscht.',
  'smartSearch.noAgents': 'Installiere oder aktiviere einen Agent für Antworten.',
  'smartSearch.noContext': 'Keine verwendbaren Ergebnisse. Stelle Ergebnisse wieder her oder ändere die Frage.',
  'smartSearch.preparing': 'Aktuelle Ergebnisse werden eingefroren…',
  'smartSearch.running': 'Agent antwortet…',
  'smartSearch.activityTitle': 'Arbeitsprotokoll',
  'smartSearch.activityWorking': 'Jeder abgeschlossene Schritt wird hier sofort angezeigt.',
  ...
  'smartSearch.activityPollingRetry': 'Statusverbindung unterbrochen; neuer Versuch ({attempt}/{max})',
  'smartSearch.activityPlanReady': 'Suchplan wurde geprüft',
  'smartSearch.activityPlanRetry': 'Planformat ungültig; Harness wird um Korrektur gebeten',
  'smartSearch.activitySearchStart': 'Strukturierter Suchplan wird ausgeführt',
  'smartSearch.activityReadRetry': 'Schreibgeschützte Suche unterbrochen; ein neuer Versuch',
  'smartSearch.activitySearchDone': '{n} Belegtreffer gefunden',
  'smartSearch.activitySearchPartial': 'Suchzeitlimit erreicht; {n} geprüfte Teilergebnisse werden verwendet',
  'smartSearch.activityTuneStart': 'Trefferabdeckung wird bewertet und der Plan optimiert',
  'smartSearch.activityTunedSearchStart': 'Optimierter Suchplan wird ausgeführt',
  'smartSearch.activityTuneFallback': 'Optimierung fehlgeschlagen; geprüfte Erstergebnisse werden verwendet',
  'smartSearch.activityFreezeStart': '{n} ausgewählte Belegquellen werden eingefroren',
  'smartSearch.activityFreezeDone': 'Belegpaket mit {n} Quellen eingefroren',
  'smartSearch.activityMemoryStart': 'Autorisierter Langzeitspeicher wird geprüft',
  'smartSearch.activityMemoryDone': '{n} autorisierte Speichereinträge ausgewählt',
  'smartSearch.activityMemorySkipped': 'Speicher nicht verfügbar; nur mit eingefrorenen Belegen fortfahren',
  'smartSearch.activityAnswerStart': 'Eingefrorenes Belegpaket wird zur Beantwortung gesendet',
  'smartSearch.activityAnswerDone': 'Antwort abgeschlossen und Zitate geprüft',
  'smartSearch.activityDocumentStart': 'Detaillierte Markdown-Notiz aus eingefrorenen Belegen wird erstellt',
  'smartSearch.activityDocumentDone': 'Detaillierte Notiz erstellt und gespeichert',
  'smartSearch.activityUserRetry': 'Neuer Versuch; eingefrorene Belege werden ohne neue Suche verwendet',
  'smartSearch.activityFailed': 'Angehalten: {error}',
  'smartSearch.taskTimedOut': 'Harness war zu lange inaktiv. Lauf-ID: {runId}',
  'smartSearch.taskLost': 'Harness endete, bevor ein Ergebnis gespeichert wurde. Lauf-ID: {runId}',
  'smartSearch.retryAnswer': 'Nur Antwort wiederholen',
  'smartSearch.retrySearch': 'Erneut suchen und antworten',
  'smartSearch.searchError': 'Suche fehlgeschlagen',
  'smartSearch.answerError': 'Der Agent konnte nicht antworten',
  'smartSearch.memoryUsed': 'Langzeitgedächtnis geladen',
  'smartSearch.openEditor': 'Im Editor öffnen',
  'smartSearch.like': 'Hilfreich',
  'smartSearch.dislike': 'Nicht hilfreich',
  'smartSearch.archived': 'Unter answers gespeichert',
  'smartSearch.feedbackSaved': 'Feedback gespeichert',
  'smartSearch.reasonFact': 'Falsch',
  'smartSearch.reasonSource': 'Quelle passt nicht',
  'smartSearch.reasonMissing': 'Wichtiges Detail fehlt',
  'smartSearch.reasonVerbose': 'Zu ausführlich',
  'smartSearch.detailed': 'Ausführliche Notiz erstellen',
  'smartSearch.documentTitle': 'Notiztitel',
  'smartSearch.generateOpen': 'Erstellen und öffnen',
  'smartSearch.generating': 'Markdown wird erstellt…',
