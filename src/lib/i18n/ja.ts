...
export const ja: Record<keyof Messages, string> = {
  ...
  // グローバルスマート検索と回答
  'smartSearch.windowTitle': 'スマート検索と回答',
  'smartSearch.placeholder': 'Vault を検索、または質問…',
  'smartSearch.inputHint': '入力中に検索 · Return で Agent に質問 · ⇧Return で改行',
  'smartSearch.modelStrategy': 'モデル戦略',
  'smartSearch.modelFast': '自動（高速）',
  'smartSearch.modelDefault': 'Harness の既定値',
  'smartSearch.planTuneModel': '理解と調整',
  'smartSearch.planTuneModelHint': '既定ではこの Agent の高速モデルを使用します',
  'smartSearch.answerModel': '最終回答',
  'smartSearch.answerModelHint': '既定ではこの Agent の高品質モデルを使用します',
  'smartSearch.planning': '質問を理解しています…',
  'smartSearch.plannedSearching': 'スマート検索を実行しています…',
  'smartSearch.tuning': '検索を調整しています…',
  'smartSearch.quickPreview': 'クイックプレビュー',
  'smartSearch.intelligentResults': 'スマート検索結果',
  'smartSearch.ask': 'Agent に質問',
  'smartSearch.results': '結果',
  'smartSearch.answer': '回答',
  ...
  'smartSearch.removedCount': '今回の回答から {n} 件除外',
  'smartSearch.undo': '取り消す',
  'smartSearch.notDeleted': '元のファイルは削除されません。',
  'smartSearch.noAgents': '回答する Agent をインストールまたは有効化してください。',
  'smartSearch.noContext': '利用できる結果がありません。結果を戻すか質問を変更してください。',
  'smartSearch.preparing': '現在の検索結果を固定中…',
  'smartSearch.running': 'Agent が回答中…',
  'smartSearch.activityTitle': '作業ログ',
  'smartSearch.activityWorking': '各ステップの完了状況がここにすぐ表示されます。',
  ...
  'smartSearch.activityPollingRetry': '状態接続が中断しました。再接続中（{attempt}/{max}）',
  'smartSearch.activityPlanReady': '検索計画を検証しました',
  'smartSearch.activityPlanRetry': '計画形式が無効なため、Harness に修正を依頼しています',
  'smartSearch.activitySearchStart': '構造化検索計画を実行しています',
  'smartSearch.activityReadRetry': '読み取り専用検索が中断しました。1 回再試行します',
  'smartSearch.activitySearchDone': '{n} 件の根拠を取得しました',
  'smartSearch.activitySearchPartial': '検索時間の上限に達したため、検証済みの部分結果 {n} 件を使用します',
  'smartSearch.activityTuneStart': '再現率を評価して計画を調整しています',
  'smartSearch.activityTunedSearchStart': '調整済み検索計画を実行しています',
  'smartSearch.activityTuneFallback': '調整に失敗したため、検証済みの初回結果を使用します',
  'smartSearch.activityFreezeStart': '選択した根拠 {n} 件を固定しています',
  'smartSearch.activityFreezeDone': '根拠パケットを {n} 件のソースで固定しました',
  'smartSearch.activityMemoryStart': '許可済み長期メモリを確認しています',
  'smartSearch.activityMemoryDone': '許可済みメモリを {n} 件選択しました',
  'smartSearch.activityMemorySkipped': 'メモリを利用できないため、固定済み根拠だけで続行します',
  'smartSearch.activityAnswerStart': '固定済み根拠パケットを Agent に送信しています',
  'smartSearch.activityAnswerDone': '回答が完了し、引用を検証しました',
  'smartSearch.activityDocumentStart': '固定済み根拠から詳細な Markdown ノートを生成しています',
  'smartSearch.activityDocumentDone': '詳細ノートを生成して保存しました',
  'smartSearch.activityUserRetry': '再試行します。再検索せず固定済み根拠を再利用します',
  'smartSearch.activityFailed': '停止しました：{error}',
  'smartSearch.taskTimedOut': 'Harness が無通信のままタイムアウトしました。実行 ID：{runId}',
  'smartSearch.taskLost': 'Harness が結果を保存する前に終了しました。実行 ID：{runId}',
  'smartSearch.retryAnswer': '回答だけ再試行',
  'smartSearch.retrySearch': '再検索して回答',
  'smartSearch.searchError': '検索に失敗しました',
  'smartSearch.answerError': 'Agent が回答できませんでした',
  'smartSearch.memoryUsed': '長期記憶を読み込みました',
  'smartSearch.openEditor': 'エディタで開く',
  'smartSearch.like': '役に立った',
  'smartSearch.dislike': '役に立たない',
  'smartSearch.archived': 'answers に保存しました',
  'smartSearch.feedbackSaved': 'フィードバックを保存しました',
  'smartSearch.reasonFact': '内容が誤っている',
  'smartSearch.reasonSource': '出典が一致しない',
  'smartSearch.reasonMissing': '重要な情報がない',
  'smartSearch.reasonVerbose': '長すぎる',
  'smartSearch.detailed': '詳しいノートを作成',
  'smartSearch.documentTitle': 'ノートのタイトル',
  'smartSearch.generateOpen': '生成して開く',
  'smartSearch.generating': 'Markdown を生成中…',
