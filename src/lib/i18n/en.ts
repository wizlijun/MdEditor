...
export const en = {
  ...
  // Global smart search & answers
  'smartSearch.windowTitle': 'Smart Search & Answers',
  'smartSearch.placeholder': 'Ask anything or search your vault…',
  'smartSearch.inputHint': 'Results appear as you type · Return asks the Agent · ⇧Return adds a line',
  'smartSearch.modelStrategy': 'Model strategy',
  'smartSearch.modelFast': 'Automatic (fast)',
  'smartSearch.modelDefault': 'Harness default',
  'smartSearch.planTuneModel': 'Understand and tune',
  'smartSearch.planTuneModelHint': 'Uses this Agent’s fast model by default',
  'smartSearch.answerModel': 'Final answer',
  'smartSearch.answerModelHint': 'Uses this Agent’s quality model by default',
  'smartSearch.planning': 'Understanding the question…',
  'smartSearch.plannedSearching': 'Running intelligent retrieval…',
  'smartSearch.tuning': 'Tuning the search…',
  'smartSearch.quickPreview': 'Quick preview',
  'smartSearch.intelligentResults': 'Intelligent results',
  'smartSearch.ask': 'Ask Agent',
  'smartSearch.results': 'Results',
  'smartSearch.answer': 'Answer',
  ...
  'smartSearch.removedCount': '{n} removed from this answer',
  'smartSearch.undo': 'Undo',
  'smartSearch.notDeleted': 'Original files were not deleted.',
  'smartSearch.noAgents': 'Install or enable an Agent provider to answer.',
  'smartSearch.noContext': 'No usable results remain. Restore a result or change the query.',
  'smartSearch.preparing': 'Freezing the current results…',
  'smartSearch.running': 'Agent is answering…',
  'smartSearch.activityTitle': 'Work log',
  'smartSearch.activityWorking': 'Updates appear here as each step completes.',
  ...
  'smartSearch.activityPollingRetry': 'Status connection was interrupted; reconnecting ({attempt}/{max})',
  'smartSearch.activityPlanReady': 'Search plan validated',
  'smartSearch.activityPlanRetry': 'Plan format was invalid; asking the harness to correct it',
  'smartSearch.activitySearchStart': 'Executing the structured search plan',
  'smartSearch.activityReadRetry': 'Read-only search was interrupted; retrying once',
  'smartSearch.activitySearchDone': 'Retrieved {n} evidence matches',
  'smartSearch.activitySearchPartial': 'Search time limit reached; keeping {n} verified partial matches',
  'smartSearch.activityTuneStart': 'Evaluating recall and tuning the plan',
  'smartSearch.activityTunedSearchStart': 'Executing the tuned search plan',
  'smartSearch.activityTuneFallback': 'Tuning failed; continuing with the verified first-pass results',
  'smartSearch.activityFreezeStart': 'Freezing {n} selected evidence sources',
  'smartSearch.activityFreezeDone': 'Frozen evidence packet contains {n} sources',
  'smartSearch.activityMemoryStart': 'Checking authorized long-term memory',
  'smartSearch.activityMemoryDone': 'Selected {n} authorized memory items',
  'smartSearch.activityMemorySkipped': 'Memory was unavailable; continuing with frozen evidence only',
  'smartSearch.activityAnswerStart': 'Sending the frozen evidence packet for answering',
  'smartSearch.activityAnswerDone': 'Answer completed and citations validated',
  'smartSearch.activityDocumentStart': 'Generating a detailed Markdown note from the frozen evidence',
  'smartSearch.activityDocumentDone': 'Detailed note generated and saved',
  'smartSearch.activityUserRetry': 'Retry requested; reusing the frozen evidence without searching again',
  'smartSearch.activityFailed': 'Stopped: {error}',
  'smartSearch.taskTimedOut': 'The harness timed out while inactive. Run ID: {runId}',
  'smartSearch.taskLost': 'The harness process ended before saving a result. Run ID: {runId}',
  'smartSearch.retryAnswer': 'Retry answer only',
  'smartSearch.retrySearch': 'Search and answer again',
  'smartSearch.searchError': 'Search failed',
  'smartSearch.answerError': 'The Agent could not answer',
  'smartSearch.memoryUsed': 'Long-term memory loaded',
  'smartSearch.openEditor': 'Open in editor',
  'smartSearch.like': 'Helpful',
  'smartSearch.dislike': 'Not helpful',
  'smartSearch.archived': 'Saved to answers',
  'smartSearch.feedbackSaved': 'Feedback saved',
  'smartSearch.reasonFact': 'Incorrect',
  'smartSearch.reasonSource': 'Source mismatch',
  'smartSearch.reasonMissing': 'Missing key detail',
  'smartSearch.reasonVerbose': 'Too verbose',
  'smartSearch.detailed': 'Create detailed note',
  'smartSearch.documentTitle': 'Note title',
  'smartSearch.generateOpen': 'Generate and open',
  'smartSearch.generating': 'Generating Markdown…',
