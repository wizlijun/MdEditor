...
export const zh: Record<keyof Messages, string> = {
  ...
  // 全局智能搜索与问答
  'smartSearch.windowTitle': '智能搜索与问答',
  'smartSearch.placeholder': '搜索知识库，或直接提问…',
  'smartSearch.inputHint': '输入即搜 · 回车问 Agent · ⇧回车换行',
  'smartSearch.modelStrategy': '模型策略',
  'smartSearch.modelFast': '自动（快速）',
  'smartSearch.modelDefault': 'Harness 默认',
  'smartSearch.planTuneModel': '理解与调优',
  'smartSearch.planTuneModelHint': '默认使用当前 Agent 的快速模型',
  'smartSearch.answerModel': '最终回答',
  'smartSearch.answerModelHint': '默认使用当前 Agent 的质量模型',
  'smartSearch.planning': '正在理解问题…',
  'smartSearch.plannedSearching': '正在执行智能检索…',
  'smartSearch.tuning': '正在优化检索…',
  'smartSearch.quickPreview': '快速预览',
  'smartSearch.intelligentResults': '智能检索结果',
  'smartSearch.ask': '问 Agent',
  ...
  'smartSearch.removedCount': '已从本次回答移除 {n} 条',
  'smartSearch.undo': '撤销',
  'smartSearch.notDeleted': '原文件没有被删除。',
  'smartSearch.noAgents': '请先安装或启用一个 Agent，才能生成回答。',
  'smartSearch.noContext': '没有可用结果。请恢复结果或换一个问题。',
  'smartSearch.preparing': '正在冻结当前检索结果…',
  'smartSearch.running': 'Agent 正在回答…',
  'smartSearch.activityTitle': '工作过程',
  'smartSearch.activityWorking': '每完成一步，当前状态都会立即显示在这里。',
  ...
  'smartSearch.activityPollingRetry': '状态连接短暂中断，正在重连（{attempt}/{max}）',
  'smartSearch.activityPlanReady': '检索计划已通过校验',
  'smartSearch.activityPlanRetry': '计划格式无效，正在要求 Harness 修正',
  'smartSearch.activitySearchStart': '正在执行结构化检索计划',
  'smartSearch.activityReadRetry': '只读检索短暂中断，正在重试一次',
  'smartSearch.activitySearchDone': '已检索到 {n} 条证据',
  'smartSearch.activitySearchPartial': '检索达到时间上限，保留 {n} 条已验证的部分结果',
  'smartSearch.activityTuneStart': '正在评估召回效果并优化计划',
  'smartSearch.activityTunedSearchStart': '正在执行优化后的检索计划',
  'smartSearch.activityTuneFallback': '调优失败，继续使用首次已验证的检索结果',
  'smartSearch.activityFreezeStart': '正在冻结选中的 {n} 条证据来源',
  'smartSearch.activityFreezeDone': '证据包已冻结，共 {n} 个来源',
  'smartSearch.activityMemoryStart': '正在检查已授权的长期记忆',
  'smartSearch.activityMemoryDone': '已选取 {n} 条授权记忆',
  'smartSearch.activityMemorySkipped': '长期记忆不可用，仅使用已冻结证据继续回答',
  'smartSearch.activityAnswerStart': '正在将冻结证据包交给 Agent 回答',
  'smartSearch.activityAnswerDone': '回答已完成，引文已校验',
  'smartSearch.activityDocumentStart': '正在基于冻结证据生成详细 Markdown 笔记',
  'smartSearch.activityDocumentDone': '详细笔记已生成并保存',
  'smartSearch.activityUserRetry': '已请求重试；复用冻结证据，不重新检索',
  'smartSearch.activityFailed': '已停止：{error}',
  'smartSearch.taskTimedOut': 'Harness 长时间无活动，任务已超时。运行 ID：{runId}',
  'smartSearch.taskLost': 'Harness 进程未保存结果就已结束。运行 ID：{runId}',
  'smartSearch.retryAnswer': '仅重试回答',
  'smartSearch.retrySearch': '重新检索并回答',
  'smartSearch.searchError': '搜索失败',
  'smartSearch.answerError': 'Agent 回答失败',
  'smartSearch.memoryUsed': '已加载长期记忆',
  'smartSearch.openEditor': '在编辑器中打开',
  'smartSearch.like': '有帮助',
  'smartSearch.dislike': '没帮助',
  'smartSearch.archived': '已保存到 answers',
  'smartSearch.feedbackSaved': '反馈已保存',
  'smartSearch.reasonFact': '事实不对',
  'smartSearch.reasonSource': '来源不匹配',
  'smartSearch.reasonMissing': '漏了关键信息',
  'smartSearch.reasonVerbose': '太啰嗦',
  'smartSearch.detailed': '生成详细笔记',
  'smartSearch.documentTitle': '笔记标题',
  'smartSearch.generateOpen': '生成并打开',
  'smartSearch.generating': '正在生成 Markdown…',
