...
export const MESSAGE_KEYS = [
  ...
  'settings',
  'ideaDir',
  // 设置面板的「委托提示词」区:每一行是一个 task 模板的 CLAUDE.md。
  'prompts',
  'promptsHint',
  'promptMain',
  'promptMissing',
...
const en: Catalog = {
  ...
  promptsHint: 'Each one opens in the main editor. Your edits stay — they are never overwritten.',
  promptMain: 'Argue an idea',
