...
const zh: Catalog = {
  ...
  agentMissing: '未找到 Claude Agent 插件',
  agentMissingHint: '请从插件市场安装 Claude Agent 插件以启用委托。',
  celebrate: '灵感不错!',
  templateH1: '新想法',
...
const ja: Catalog = {
  ...
  agentMissing: 'Claude Agent プラグインが見つかりません',
  agentMissingHint: '委任を有効にするには、マーケットプレイスから Claude Agent プラグインをインストールしてください。',
  celebrate: 'いいひらめきですね!',
  templateH1: '新しいアイデア',
