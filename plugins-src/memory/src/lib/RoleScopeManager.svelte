...
<div class="scrim" role="presentation">
  <div class="manager-sheet" role="dialog" aria-modal="true" aria-labelledby="role-scope-title">
    ...
    <nav class="views" aria-label="身份与场景区域">
      <button class:active={view === 'roles'} onclick={() => view = 'roles'}>Roles</button>
      <button class:active={view === 'scopes'} onclick={() => view = 'scopes'}>Scopes</button>
      <button class:active={view === 'reassign'} onclick={() => view = 'reassign'}>重新分配</button>
    </nav>
