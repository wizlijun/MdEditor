...
const en: Catalog = {
  ...
  statusFailed: 'No report produced',
  menuOpenReport: 'Edit report here',
  menuOpenRequest: 'Edit the request here',
  menuReload: 'Load back into the editor',
  menuDelete: 'Delete',
...
const zh: Catalog = {
  ...
  statusRunning: '溯源中',
  statusFailed: '未产出报告',
  menuOpenReport: '在此编辑报告',
  menuOpenRequest: '在此编辑委托稿',
  menuReload: '载回编辑器',
  menuDelete: '删除',
...
const ja: Catalog = {
  ...
  statusDone: 'レポート完成',
  statusRunning: '追跡中',
  statusFailed: 'レポート未生成',
  menuOpenReport: 'ここでレポートを編集',
  menuOpenRequest: 'ここで依頼文を編集',
  menuReload: 'エディタに読み戻す',
  menuDelete: '削除',
...
const de: Catalog = {
  ...
  statusDone: 'Bericht fertig',
  statusRunning: 'Suche läuft',
  statusFailed: 'Kein Bericht erzeugt',
  menuOpenReport: 'Bericht hier bearbeiten',
  menuOpenRequest: 'Anfrage hier bearbeiten',
  menuReload: 'Zurück in den Editor laden',
  menuDelete: 'Löschen',
